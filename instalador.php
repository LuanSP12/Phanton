...
require_once("classes/Instalador.class.php");
$instalador = new Instalar();
...
<head>
    ...
    <!-- css responsive -->
    <link rel="stylesheet" href="/assets/css/instalador.css" type="text/css" media="all">
...
<section id="about" class="intro bg-about">
    <div class="container">
        ...
        <div class="row">
			...
			$database = $_POST['data'];
			$remoto = $_POST['remoto'];
			$ip_cpanel = $_POST['hostname_cpanel'];
			$usuario_cpanel = $_POST['root_cpanel'];
			$senha_cpanel = $_POST['senha_cpanel'];
			$licenca = $_POST['licenca'];
			
			if($instalador->Painel($hostname, $root, $senha, $database, $remoto, $licenca, $ip_cpanel, $usuario_cpanel, $senha_cpanel)){
				
				Echo "<div class='alert alert-success''>Sucesso o painel foi instalado com sucesso</div>";
				
			}else {
				echo "<div class='alert alert-danger'>Ocorreu uma falha na instalação</div>";
			}
		...
		<div class="col-md-6">
            ...
            <div class="form-group has-feedback">
                <div class="pterodactyl-login-input">
                    <input type="text" class="form-control input-lg" value="" required="" name="hostname" placeholder="Hostname" autofocus="">
                    <span class="fa fa-envelope form-control-feedback fa-lg"></span>
                </div>
            </div>
            <div class="form-group has-feedback">
                <div class="pterodactyl-login-input">
                    <input type="text" class="form-control input-lg" required=""  name="root" placeholder="Usuário Root">
			...
			<div class="form-group has-feedback">
                <div class="pterodactyl-login-input">
                    <input type="text" class="form-control input-lg" required=""  name="remoto" placeholder="IP Remoto">
                    <span class="fa fa-lock form-control-feedback fa-lg"></span>
                </div>
            </div>
				<div class="form-group has-feedback">
                <div class="pterodactyl-login-input">
                    <input type="password" class="form-control input-lg"  name="senha" placeholder="Senha Root">
                    <span class="fa fa-lock form-control-feedback fa-lg"></span>
                </div>
            </div>
			...
			<div class="form-group has-feedback">
                <div class="pterodactyl-login-input">
                    <input type="text" class="form-control input-lg" required=""  name="data" placeholder="Database">
                    <span class="fa fa-lock form-control-feedback fa-lg"></span>
                </div>
            </div>
		  ...
		  <div class="row">
	   <div class="col-md-12">
	   <H3>Configurações CPanel </H3>
	   </div>
		<div class="col-md-6">
		
            <div class="form-group has-feedback">
                <div class="pterodactyl-login-input">
                    <input type="text" class="form-control input-lg" value="" required="" name="hostname_cpanel" placeholder="IP CPanel" autofocus="">
                    <span class="fa fa-envelope form-control-feedback fa-lg"></span>
                </div>
            </div>
            <div class="form-group has-feedback">
                <div class="pterodactyl-login-input">
                    <input type="text" class="form-control input-lg" required=""  name="root_cpanel" placeholder="Usuário Root">
                    <span class="fa fa-lock form-control-feedback fa-lg"></span>
			...
			<div class="form-group has-feedback">
                <div class="pterodactyl-login-input">
                    <input type="password" class="form-control input-lg" required=""  name="senha_cpanel" placeholder="Senha Root">
                    <span class="fa fa-lock form-control-feedback fa-lg"></span>
                </div>
            </div>
			</div>
			...
			<div class="form-group has-feedback">
                <div class="pterodactyl-login-input">
                    <input type="text" class="form-control input-lg" required=""  name="ip_cpanel" placeholder="IP Remoto">
                    <span class="fa fa-lock form-control-feedback fa-lg"></span>
                </div>
            </div>
			<div class="form-group has-feedback">
                <div class="pterodactyl-login-input">
                    <input type="text" class="form-control input-lg" required=""  name="licenca" placeholder="Licença">
                    <span class="fa fa-lock form-control-feedback fa-lg"></span>
                </div>
            </div>
  <div class="row">
                    ...
                    <button type="submit" name="btn-login" class="btn btn-block g-recaptcha pterodactyl-login-button--main">Instalar</button>
